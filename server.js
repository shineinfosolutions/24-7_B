...
app.use(cors({
  origin: ['http://localhost:5173','http://zomato-frontend-blush.vercel.app', 'http://127.0.0.1:5500', 'https://zomato-frontend-ashen.vercel.app','https://zomato-admin-seven.vercel.app'],
  credentials: true,
